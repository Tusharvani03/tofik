...
<section class="xs-welcome-slider">
	<div class="xs-banner-slider owl-carousel">
		<div class="xs-welcome-content" style="background-image: url(<?php echo base_url();?>assetss/images/slider_1.jpg);">
			<div class="container">
				<div class="xs-welcome-wraper color-white">
					<img src="<?php echo base_url();?>assetss/images/welcome-text-1.png" alt>
		...
		<div class="xs-welcome-content" style="background-image: url(<?php echo base_url();?>assetss/images/slider_2.jpg);">
			<div class="container">
				<div class="xs-welcome-wraper color-white">
					<img src="<?php echo base_url();?>assetss/images/welcome-text-1.png" alt>
					<h2>Hunger is stalking the globe</h2>
		...
		<div class="xs-welcome-content" style="background-image: url(<?php echo base_url();?>assetss/images/slider_3.jpg);">
			<div class="container">
				<div class="xs-welcome-wraper color-white">
					<img src="<?php echo base_url();?>assetss/images/welcome-text-1.png" alt>
					<h2>Hunger is stalking the globe</h2>
	...
	<div class="container">
		<div class="xs-heading row xs-mb-60">
			<div class="col-md-9 col-xl-9">
				<h2 class="xs-title">Donations</h2>
			...
			<div class="col-xl-3 col-md-3 xs-btn-wraper">
				<a href="" class="btn btn-primary bg-orange">DONATE NOW</a>
			</div><!-- .xs-btn-wraper END -->
		</div><!-- .row end -->
...
<section class="xs-what-we-do-image">
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div class="xs-service-promo box-image" style="background-image: url(<?php echo base_url();?>assetss/images/category_1.jpg)">
					<span class="icon-groceries"></span>
					<h5>Zakat Donate</h5>
					<p>his program enables volunteers like you to run their own charities without the stress of creating and registering their own organizations.</p>
					<div class="xs-black-overlay bg-aqua"></div>
				</div><!-- .xs-service-promo END -->
			</div>
			<div class="col-md-4">
				<div class="xs-service-promo box-image" style="background-image: url(<?php echo base_url();?>assetss/images/category_2.jpg)">
					<span class="icon-care"></span>
					<h5>Sadaqah</h5>
					<p>By giving a monthly Sadaqa of as little as $10 a month, you can help Crescent relief plan, execute
and sustain 10 charity projects. As a result, the Barakah of your Sadaqa will be extended to hundreds of needy people.</p>
					<div class="xs-black-overlay bg-purple"></div>
				</div><!-- .xs-service-promo END -->
			</div>
			<div class="col-md-4">
				<div class="xs-service-promo box-image" style="background-image: url(<?php echo base_url();?>assetss/images/category_3.jpg)">
	...
	<div class="container-fulid">
		<div class="row">
			<div class="col-md-12 col-lg-6">
				<div class="xs-about-content-img" style="background-image:url('<?php echo base_url();?>assetss/images/about_img.jpg')"></div>
			</div>
			<div class="col-md-12 col-lg-6">
				<div class="xs-about-content">
					...
					<ul class="xs-unorder-list circle">
						<li>Zakat Donation </li>
						<li>Sadaqah</li>
						<li>Qurbani</li>
						<li>Fitra</li>
						<li>Food Donate</li>
						<li>General Donate</li>
						<li>Fitra</li>
					</ul>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-popular-item xs-box-shadow">
					<div class="xs-item-header">
						...
						<img src="<?php echo base_url();?>assetss/images/causes_4.jpg" alt>
					...
					<div class="xs-item-content">
						...
						<div class="row xs-margin-0">
							<div class="xs-round-avatar">
								<img src="<?php echo base_url();?>assetss/images/avatar_1.jpg" alt>
							</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-popular-item xs-box-shadow">
					<div class="xs-item-header">
						...
						<img src="<?php echo base_url();?>assetss/images/causes_5.jpg" alt>
					...
					<div class="xs-item-content">
						...
						<div class="row xs-margin-0">
							<div class="xs-round-avatar">
								<img src="<?php echo base_url();?>assetss/images/avatar_2.jpg" alt>
							</div>
							<div class="xs-avatar-title">
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-popular-item xs-box-shadow">
					<div class="xs-item-header">
						...
						<img src="<?php echo base_url();?>assetss/images/causes_6.jpg" alt>
					...
					<div class="xs-item-content">
						...
						<div class="row xs-margin-0">
							<div class="xs-round-avatar">
								<img src="<?php echo base_url();?>assetss/images/avatar_3.jpg" alt>
							</div>
							<div class="xs-avatar-title">
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-popular-item xs-box-shadow">
					<div class="xs-item-header">
						...
						<img src="<?php echo base_url();?>assetss/images/causes_7.jpg" alt>
					...
					<div class="xs-item-content">
						...
						<div class="row xs-margin-0">
							<div class="xs-round-avatar">
								<img src="<?php echo base_url();?>assetss/images/avatar_4.jpg" alt>
							</div>
							<div class="xs-avatar-title">
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-popular-item xs-box-shadow">
					<div class="xs-item-header">
						...
						<img src="<?php echo base_url();?>assetss/images/causes_8.jpg" alt>
					...
					<div class="xs-item-content">
						...
						<div class="row xs-margin-0">
							<div class="xs-round-avatar">
								<img src="<?php echo base_url();?>assetss/images/avatar_5.jpg" alt>
							</div>
							<div class="xs-avatar-title">
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-popular-item xs-box-shadow">
					<div class="xs-item-header">
						...
						<img src="<?php echo base_url();?>assetss/images/causes_11.jpg" alt>
					...
					<div class="xs-item-content">
						...
						<div class="row xs-margin-0">
							<div class="xs-round-avatar">
								<img src="images/avatar_6.jpg" alt>
							</div>
							<div class="xs-avatar-title">
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-3">
				<div class="xs-feature-image">
					<img src="<?php echo base_url();?>assetss/images/features_1.jpg" alt>
				</div><!-- .xs-feature-image END -->
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="xs-feature-image">
					<img src="<?php echo base_url();?>assetss/images/features_2.jpg" alt>
				</div><!-- .xs-feature-image END -->
			</div>
		</div><!-- .row end -->
	</div><!-- .container end -->
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-6 row xs-single-event event-green">
				<div class="col-md-5">
					<div class="xs-event-image">
						<img src="<?php echo base_url();?>assetss/images/event_1.jpg" alt>
			...
			<div class="col-lg-6 row xs-single-event event-purple">
				<div class="col-md-5">
					<div class="xs-event-image">
						<img src="<?php echo base_url();?>assetss/images/event_2.jpg" alt>
						<div class="xs-entry-date">
			...
			<div class="col-lg-6 row xs-single-event event-red">
				<div class="col-md-5">
					<div class="xs-event-image">
						<img src="<?php echo base_url();?>assetss/images/event_3.jpg" alt>
						<div class="xs-entry-date">
			...
			<div class="col-lg-6 row xs-single-event event-blue">
				<div class="col-md-5">
					<div class="xs-event-image">
						<img src="<?php echo base_url();?>assetss/images/event_4.jpg" alt>
						<div class="xs-entry-date">
...
<!-- partners section -->
<section class="bg-gray xs-partner-section" style="background-image: url('<?php echo base_url();?>assetss/images/map.png');">
	<div class="container">
		<div class="row">
			<div class="col-lg-5">
			...
			<div class="col-lg-7">
				<ul class="fundpress-partners">
					<li><a href="#"><img src="<?php echo base_url();?>assetss/images/client_1.png" alt></a></li>
					<li><a href="#"><img src="<?php echo base_url();?>assetss/images/client_2.png" alt></a></li>
					<li><a href="#"><img src="<?php echo base_url();?>assetss/images/client_3.png" alt></a></li>
					<li><a href="#"><img src="<?php echo base_url();?>assetss/images/client_4.png" alt></a></li>
					<li><a href="#"><img src="<?php echo base_url();?>assetss/images/client_5.png" alt></a></li>
				</ul>
			</div>
		</div><!-- .row end -->
	</div><!-- .container end -->
					...
					<div class="entry-thumbnail ">
						...
						<div class="post-author">
							<span class="xs-round-avatar">
								<img class="img-responsive" src="images/avatar_1.jpg" alt>
							</span>
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-box-shadow xs-single-journal  xs-mb-30">
					<div class="entry-thumbnail ">
						...
						<div class="post-author">
							<span class="xs-round-avatar">
								<img class="img-responsive" src="images/avatar_2.jpg" alt>
							</span>
							<span class="author-name">
								<a href="#">By Julian</a>
							</span>
			...
			<div class="col-lg-4 col-md-6">
				<div class="xs-box-shadow xs-single-journal  xs-mb-30">
					<div class="entry-thumbnail ">
						...
						<div class="post-author">
							<span class="xs-round-avatar">
								<img class="img-responsive" src="images/avatar_3.jpg" alt>
							</span>
							<span class="author-name">
								<a href="#">By Evan</a>
							</span>
