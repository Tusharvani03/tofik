...
<section class="xs-banner-inner-section parallax-window" style="background-image:url('<?php echo base_url();?>assetss/images/contact_bg.jpg')">
		...
		<div class="row">
				...
				<div class="xs-contact-details">
					<div class="xs-widnow-wraper">
						<div class="xs-window-top">
							<img src="<?php echo base_url();?>assetss/images/contact-info-img-1.png" alt>
						</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="xs-contact-details">
					<div class="xs-widnow-wraper">
						<div class="xs-window-top">
							<img src="<?php echo base_url();?>assetss/images/contact-info-img-2.png" alt>
						</div>
						<div class="xs-window-back">
			...
			<div class="col-md-6 col-lg-4">
				<div class="xs-contact-details">
					<div class="xs-widnow-wraper">
						<div class="xs-window-top">
							<img src="<?php echo base_url();?>assetss/images/contact-info-img-3.png" alt>
						</div>
						<div class="xs-window-back">
