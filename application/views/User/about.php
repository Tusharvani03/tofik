...
<section class="xs-banner-inner-section parallax-window" style="background-image:url('<?php echo base_url();?>assetss/images/about_bg.jpg')">
...
<main class="xs-main">
		...
		<div class="row">
			<div class="col-lg-8 content-center">
				<div class="xs-video-popup-wraper">
					<img src="<?php echo base_url();?>assetss/images/video_img.jpg" alt>
	...
	<!-- funfacts section -->
	<div class="xs-funfact-section xs-content-section-padding waypoint-tigger parallax-window" style="background-image: url('<?php echo base_url();?>assetss/images/parallax_1.jpg')">
	<div class="container">
		...
		<div class="row xs-mb-60">
			<div class="col-md-6 col-lg-3">
				<div class="xs-single-team">
					<img src="<?php echo base_url();?>assetss/images/team_1.png" alt>
			...
			<div class="col-md-6 col-lg-3">
				<div class="xs-single-team">
					<img src="<?php echo base_url();?>assetss/images/team_2.png" alt>
					<div class="xs-team-content">
						<h4>Mr. Aladin</h4>
			...
			<div class="col-md-6 col-lg-3">
				<div class="xs-single-team">
					<img src="<?php echo base_url();?>assetss/images/team_3.png" alt>
					<div class="xs-team-content">
						<h4>Zummon Khan</h4>
			...
			<div class="col-md-6 col-lg-3">
				<div class="xs-single-team">
					<img src="<?php echo base_url();?>assetss/images/team_4.png" alt>
					<div class="xs-team-content">
						<h4>Harista Pro</h4>
						<small>Volunteer</small>
						<svg class="xs-svgs" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 270 138">
	...
	<!-- partners section -->
	<section class="xs-partner-section" style="background-image: url('<?php echo base_url();?>assetss/images/map.png');">
	<div class="container">
		<div class="row">
			<div class="col-lg-5">
